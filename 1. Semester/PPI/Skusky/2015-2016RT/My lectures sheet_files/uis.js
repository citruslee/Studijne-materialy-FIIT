...
var uis = new function () {
	...
	/*
	 * 2013/06/13 Tom È.
	 * Metody pro zabaleni jquery http requestù a pouzití transportních parametrù
	 * parametry jsou stejný jako u odpovídajících jquery funkcí
	 */
...
*/
	...
	this.processSearchButtons = function () {
		jQuery( 'input.uisSearchInput' ).bind( 'keypress', function ( e ) {
...
/*
 * podpora pro transportní parametry v UISU
 *
 * 
 */
