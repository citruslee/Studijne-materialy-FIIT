 ...
 * Datum:  
 * Zadanie: zadanie07c
 * Kompilacia: cc pripravne_07c.c -o pripravne_07c
 *
 * Text zadania:
 * Napiste program, ktory spusti program zadany parametrom prog (bez argumentov),
 * pricom standardny vystup z tohto programu vypisuje na standardny vystup 
 * a zaroven do suboru zadaneho parametrom logfile. 
 * V pripade, ze nie je zadany argument prog, standardny vstup sa skopiruje 
 * na standardny vystup a zaroven do suboru logfile.
 *  
 * Syntax:
 * zadanie2 [-h] logfile [prog]
 *  
